...
* **Purpose:** This script is intended to ease new users into the Linux ecosystem by automating setup steps. This script is meant to be a one input plug and play script, however you may be prompted for your `sudo` password more than once.
